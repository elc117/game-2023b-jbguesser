...
public class GameScreen implements Screen {
    ...
    //setando as fotos
      ...
      public static int[] rpt = new int[4];
      public static int numRod = Silveira.numRod;
      int reserva;
